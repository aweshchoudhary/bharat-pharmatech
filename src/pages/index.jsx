        ...
        <section className="about-section md:flex px-5 pt-10">
          ...
          <div className="flex-1 md:pl-10">
            ...
            <p className="mt-5">
              ...
              harum consequuntur consequatur deserunt eos ipsa. Dolores illo
              dicta numquam mollitia sapiente odit corrupti tenetur rerum vero,
              at cum, consectetur sed? Expedita facere ipsum sed vero recusandae
              quidem odit aliquam, qui architecto ducimus reiciendis,
              <br />
              <br />
              culpa asperiores cumque ab quae error. Qui, saepe vel error
              quaerat animi placeat voluptate. Maiores, obcaecati repellat!
              Assumenda qui molestiae nihil.
            </p>
            <div className="mt-5">
